...
namespace Btkalman.Util {
    public class Vectors {
        ...
        public static string ToStringPrecise(Vector2 v) {
            return string.Format("({0}, {1})", v.x, v.y);
        }

        public static string ToStringPrecise(Vector3 v) {
        ...
        public static Vector2 X2(float x) {
        ...
        public static Vector2 Y2(float y) {
